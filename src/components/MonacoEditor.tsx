...
export default function MonacoEditor({
  ...
  useEffect(() => {
    ...
    //   const mdElements = htmlData.querySelectorAll('md[level="1"]');
    //   mdElements.forEach(element => {
        
    // });
      //convL0MDEditToString(markedData, htmlData);
  ...
  /*useEffect(() => {
    ...
    if(state.tag === "MD"){
      console.log("MD Tag", state);
      // TODO: updatte html, select element by id editor, clone and set it to html
    }
  }, [state])*/
